...
class DiscriminatorCQT(nn.Module):
    def __init__(self, cfg: AttrDict, hop_length: int, n_octaves:int, bins_per_octave: int):
        ...
        print(
            f"[INFO] Using nnAudio CQT2010v2 with fs={self.fs} * 2, hop_length={self.hop_length}, n_bins={self.bins_per_octave} * {self.n_octaves}, bins_per_octave={self.bins_per_octave}"
        )
